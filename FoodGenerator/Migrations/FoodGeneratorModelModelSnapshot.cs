...
{
    [DbContext(typeof(FoodGeneratorModel))]
    partial class FoodGeneratorModelModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FoodGenerator.Model.Allergies", b =>
                {
            ...
            modelBuilder.Entity("FoodGenerator.Model.BreakfastMeals", b =>
                {
                    ...
                    b.Property<string>("MealDesciption");
            ...
            modelBuilder.Entity("FoodGenerator.Model.Calander", b =>
                {
            ...
            modelBuilder.Entity("FoodGenerator.Model.DinnerMeals", b =>
                {
            ...
            modelBuilder.Entity("FoodGenerator.Model.FamilyData", b =>
                {
            ...
            modelBuilder.Entity("FoodGenerator.Model.FoodDetails", b =>
                {
            ...
            modelBuilder.Entity("FoodGenerator.Model.LunchMeals", b =>
                {
            ...
            modelBuilder.Entity("FoodGenerator.Model.MealCategories", b =>
                {
                    b.Property<int>("MealCategoriesId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("FoodGenerator.Model.RecipeDetails", b =>
                {
                    b.Property<int>("RecipeDetailsId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("FoodGenerator.Model.Utility", b =>
                {
                    b.Property<int>("UtilityId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("FoodGenerator.Model.BreakfastMeals", b =>
                {
                    b.HasOne("FoodGenerator.Model.MealCategories", "Meal")
                        .WithMany()
                        .HasForeignKey("MealCategoriesId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("FoodGenerator.Model.Utility", "Utilities")
                        .WithMany()
            ...
            modelBuilder.Entity("FoodGenerator.Model.FoodDetails", b =>
                {
                    b.HasOne("FoodGenerator.Model.Allergies", "Allergies")
                        .WithMany()
            ...
            modelBuilder.Entity("FoodGenerator.Model.MealCategories", b =>
                {
                    b.HasOne("FoodGenerator.Model.RecipeDetails", "RecipeDetails")
                        .WithMany()
            ...
            modelBuilder.Entity("FoodGenerator.Model.RecipeDetails", b =>
                {
                    b.HasOne("FoodGenerator.Model.FoodDetails", "FoodDetails")
                        .WithMany()
